...
export default function OurStory() {
  ...
  const defaultStory = {
    ...
    heroImage: "https://images.unsplash.com/photo-1595428774223-ef52624120d2?auto=format&fit=crop&q=80&w=2000",
    craftImage: "https://images.unsplash.com/photo-1608528577891-eb055944f2e7?auto=format&fit=crop&q=80&w=1000",
    heritageHeading: "Our Eternal Heritage",
    heritageDescription: "India has always had a deep connection with fragrances, attars, and natural perfume oils. From traditional ittars to exotic floral and woody notes, our culture has celebrated scents for generations. So I began asking myself: when we have the knowledge, heritage, and love for fragrances right here in our country, why should people depend on imported perfume oils at premium prices?",
    purposeHeading: "Luxury Within Reach",
    purposeDesc1: "I started researching perfume oils, fragrance compositions, and the art behind long-lasting scents with one goal in mind — to create premium-quality perfume oils that feel luxurious, last all day, and remain affordable for everyone.",
    purposeDesc2: "Itran was built to bring high-quality perfume oils closer to people who truly appreciate fragrance. Every bottle represents passion, craftsmanship, and the belief that luxury fragrances can be proudly created for our people, in our own country.",
    purposeQuote: "Because fragrance is not just something you wear — it becomes a part of your identity.",
    stats: [
  ...
  return (
    <div style={{ paddingTop: '0' }}>
      ...
      <section className="shop-hero">
        <img 
          src={heroImages?.ourStory || story.heroImage || "https://images.unsplash.com/photo-1595428774223-ef52624120d2?auto=format&fit=crop&q=80&w=2000"}
          alt="Our Story Hero"
        />
                ...
                <Reveal key={i} delay={i * 0.1} className="reveal-up">
                  {stat.icon && (
                    stat.icon.startsWith('http') || stat.icon.startsWith('/') ? (
                      <img src={stat.icon} alt="" style={{ width: '40px', height: '40px', objectFit: 'contain', marginBottom: '0.5rem', display: 'inline-block', opacity: 0.8 }} />
                    ) : (
        ...
        <div className="container">
          ...
          <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center', padding: '6rem 0', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }}>
            <Reveal>
              ...
              <h3 style={{ fontSize: '2.5rem', marginBottom: '1.5rem', fontFamily: 'var(--font-serif)' }}>{story.heritageHeading || "Our Eternal Heritage"}</h3>
              <p style={{ color: 'var(--muted-foreground)', lineHeight: 2, fontSize: '1.15rem', maxWidth: '800px', margin: '0 auto' }}>
                {story.heritageDescription || "India has always had a deep connection with fragrances, attars, and natural perfume oils. From traditional ittars to exotic floral and woody notes, our culture has celebrated scents for generations. So I began asking myself: when we have the knowledge, heritage, and love for fragrances right here in our country, why should people depend on imported perfume oils at premium prices?"}
              </p>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap-reverse', alignItems: 'center', gap: '5rem', marginTop: '6rem' }}>
            <Reveal direction="right" style={{ flex: '1 1 380px', maxWidth: '100%' }}>
              ...
              <h3 style={{ fontSize: '2.2rem', marginBottom: '1.5rem', fontFamily: 'var(--font-serif)' }}>{story.purposeHeading || "Luxury Within Reach"}</h3>
              <p style={{ color: 'var(--muted-foreground)', lineHeight: 1.9, marginBottom: '1.5rem', fontSize: '1.05rem' }}>
                {story.purposeDesc1 || "I started researching perfume oils, fragrance compositions, and the art behind long-lasting scents with one goal in mind — to create premium-quality perfume oils that feel luxurious, last all day, and remain affordable for everyone."}
              </p>
              <p style={{ color: 'var(--muted-foreground)', lineHeight: 1.9, marginBottom: '2rem', fontSize: '1.05rem' }}>
                {story.purposeDesc2 || "Itran was built to bring high-quality perfume oils closer to people who truly appreciate fragrance. Every bottle represents passion, craftsmanship, and the belief that luxury fragrances can be proudly created for our people, in our own country."}
              </p>
              <p style={{ color: 'var(--foreground)', fontSize: '1.25rem', fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: 600 }}>
                {story.purposeQuote || "Because fragrance is not just something you wear — it becomes a part of your identity."}
              </p>
            </Reveal>
            <Reveal direction="left" className="img-reveal-wrapper" style={{ flex: '1 1 420px', maxWidth: '100%', height: '550px', maxHeight: '70vh' }}>
              <img src={story.craftImage || "https://images.unsplash.com/photo-1608528577891-eb055944f2e7?auto=format&fit=crop&q=80&w=1000"} alt="Itran Formulation Craft" className="img-reveal loaded" />
            </Reveal>
          </div>
        </div>
      </section>
